...
public class Cubo implements GLEventListener {
	...
	public void display( GLAutoDrawable drawable ) {
		...
		glu.gluLookAt(Math.cos(rtri) * 16, 0, Math.sin(rtri) * 16, 0, 0, 0, 0, 1, 0);
		...
		gl.glEnd(); // Completa o desenho do Cubo

		//Desenha o piso em matriz
		float i = -10.0f;
...
//		float l = 0.0f;
//		while(l!=360.0f){
//		gl.glVertex3f(float(Math.cos(l)) * 1.0f,0.0f,float(Math.sin(l)) * 1.0f);
//		gl.glVertex3f((float(Math.cos(l)) * 1.0f)-1.0f,0.0f,0.0f,(float(Math.sin(l)) * 1.0f)-1.0f);
//		l=l+1.0f;
//		}
		
		gl.glEnd();//acaba desenho do piso em matriz
